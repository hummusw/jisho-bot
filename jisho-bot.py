...
__EMBED_HELP_FIELD_LOOKUP_VALUE = f'`{__COMMAND_PREFIX} {__COMMAND_SEARCH} <query>` - Searches jisho.org for `query`, shows first five results\n'\
                                  + f'`{__COMMAND_PREFIX} {__COMMAND_DETAILS} <num> <query>` - Shows details for the `num`th result for `query`'
__EMBED_HELP_FIELD_UTILITY_NAME = '__Utility commands__'
__EMBED_HELP_FIELD_UTILITY_VALUE = f'`{__COMMAND_PREFIX} {__COMMAND_HELP}` - Shows this help message\n' \
                                   + f'`{__COMMAND_PREFIX} {__COMMAND_PING}` - Pings jisho-bot to respond with a pong'
