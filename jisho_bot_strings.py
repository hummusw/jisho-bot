...
API_SEARCH_STEM = 'https://jisho.org/api/v1/search/words?keyword={query}'
EMOJI_NUMS = {1: ':one:', 2: ':two:', 3: ':three:', 4: ':four:', 5: ':five:'} # mabye this should be combined with REACT_NUMS
PING_RESPONSE = ':ping_pong: Pong! :ping_pong:'
...
MESSAGE_LOGIN = 'Logged in!'
MESSAGE_LOGOUT = 'Logged out!'
MESSAGE_LOGCOMMAND_STEM = 'jisho-bot command by {user}: {command}'
...
# Command strings
COMMAND_PREFIX = '!jisho'
COMMAND_PREFIX_ALIAS = '!j'

HELP_DESCRIPTION_STEM = 'jisho-bot {command} command help'
